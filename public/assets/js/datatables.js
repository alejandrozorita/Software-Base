...
$(document).ready(function() {
    ...
    tableElement.dataTable( {
		...
		"oLanguage": {
			"sLengthMenu": "_MENU_ ",
			"sInfo": "Mostradas <b>_START_ a _END_</b> de _TOTAL_ resultados"
		},
		 bAutoWidth     : false,
    ...
    var oTable = $('#example2').dataTable( {
       ...
       "aaSorting": [],
				"oLanguage": {
			"sLengthMenu": "_MENU_ ",
			"sInfo": "Mostrados <b>_START_ a _END_</b> de _TOTAL_ resultados"
		},
    });
	 ...
	 var tablaFicheros = $('#tablaFicheros').dataTable( {
	   "sDom": "<'row'<'col-md-6'l <'toolbar'>><'col-md-6'f>r>t<'row'<'col-md-12'p i>>",
        			"oTableTools": {
			"aButtons": [
				{
	 ...
	 var tablaFicherosGrupoSeccion = $('#tablaFicherosGrupoSeccion').dataTable( {
	   "sDom": "<'row'<'col-md-6'l <'toolbar'>><'col-md-6'f>r>t<'row'<'col-md-12'p i>>",
        			"oTableTools": {
			"aButtons": [
				{
	...
	$("div.toolbar").html('<div class="table-tools-actions"><button class="btn btn-lg btn-primary" id="nuevo_documento_tabla" style="margin-left:12px" data-toggle="modal" data-target="#myModal">Añadir</button></div>');
...
{
    var userCIF = "{{$cliente->nombre_empresa}}";
    var aData = oTable.fnGetData( nTr );
    var sOut = '<table cellpadding="5" cellspacing="0" border="0" style="padding-left:50px;" class="inner-table">';
    sOut += '<tr><td>Rendering engine:</td><td>{{'+userCIF+'}}</td></tr>';
